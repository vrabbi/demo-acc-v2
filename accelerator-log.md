...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=vrabbi&repo=demo-acc-v2",
  "owner" : "platform-team",
  "system" : "system:demo-apps"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->demo-acc-v2]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=vrabbi&repo=demo-acc-v2'
